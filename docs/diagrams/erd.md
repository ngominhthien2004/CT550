...
> **Entities:** 19 Mongoose models across 6 domain groups
...
erDiagram
  ...
  USER ||--o{ ILLUWRL_REQUEST : "initiates as requester"
  USER ||--o{ ILLUWRL_REQUEST : "receives as recipient"
...
| **Social Request System** | ILLUWRL_REQUEST | Friend/connection requests between users |
...
| 18 | **REQUEST_REVISION** | 7 | 2 relationships | Commission System |
| 19 | **ILLUWRL_REQUEST** | 5 | 2 relationships | Social Request System |

---
*Generated by `scripts/generate-erd.js` on 2026-06-10 — 19 entities, 37 relationships.*