...
| FE/BE Parity Close: Follow + Messages + Notifications | FE, BE, DB | Implementation Executor | Done | docs/tasks/backend-feature-checklist.md | pending push | Frontend build ok, API smoke ok, MongoDB MCP validation ok | 2026-04-08 |
