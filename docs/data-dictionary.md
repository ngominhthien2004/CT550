...
| Trường | Kiểu | Ràng buộc | Mô tả |
|--------|------|-----------|-------|
| `_id` | string | PK | singleton key: global |
...
| `isRead` | boolean | — | Đánh dấu đã đọc |
| `readAt` | datetime | — | Thời điểm đọc thông báo |
...
| `gifNotes` | json | — | Ghi chú GIF (thời gian hiển thị từng khung hình) |
...
---
*Được tạo bởi `scripts/generate-data-dictionary.js` vào 2026-06-11 — 19 thực thể, 35 quan hệ.*
