...
Mô hình dữ liệu mức quan niệm gồm có 26 thực thể. Trong đó, thực thể **USER** (Người dùng) là thực thể trung tâm, với khoá chính là `_id`.
...
_Cập nhật lần cuối: 2026-07-09 — 26 thực thể, 45+ quan hệ._
